...
![Database diagram](https://raw.githubusercontent.com/prisma/prisma-schema-examples/main/music-streaming-service/diagram.png)
...
2. Next up, you'll need to set up a local database that you can work against. If you're new to databases, we recommend [reading up](https://www.prisma.io/dataguide/) on them. This guide also has instructions on how to set up a local database.
